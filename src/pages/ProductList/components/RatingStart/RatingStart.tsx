...
function RatingStart({ queryConfig }: Props) {
  const navigate = useNavigate()
  const handleFilterStart = (ratingNumber: number) => {
    navigate({
      pathname: '/',
      search: createSearchParams({
        ...queryConfig,
        rating_filter: ratingNumber.toString()
      }).toString()
    })
  }
  return (
            ...
            >
              {Array(5)
                ...
                .map((_, indexStart) => {
                  ...
                  return (
                    <svg key={indexStart} viewBox='0 0 30 30' className='w-4 h-4 mr-2'>
                      <defs>
